...
import { type IProfile, profileValidation } from "../../../intefaces";
...
const SecurityProfileById: FC<Props> = ({ profile, mode }) => {
  ...
  const createProfile = trpc.security.createProfile.useMutation();

  const updateProfile = trpc.security.profileUpdate.useMutation();
